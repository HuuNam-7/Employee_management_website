                                            ...
                                            <div class="row m-l-0 m-r-0">
                                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                                    <div class="card-block imgProfile text-center text-white mt-5">
                                                        <div class="my-auto">
                                                            <img src="images/<?= $img ?>"
                                                                class="img-radius w-50 view overlay hm-zoom"
                                                    ...
                                                    <div class="card-block my-auto">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <h6 class="text-muted f-w-400"><?= $departID ?></h6>
                                                            </div>
                                                        </div>
                                                        <hr class="bg-white">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <form method="post" action="editProfileEmp.php">
                                                                    <div class="button-group pl-0 pt-3">
                                                                        <a class="btn btn-light"
                                                                            href="editProfileEmp.php?id=<?= $id ?>"
                                                                            role="button">Edit</a>
                                                                        <button type="button"
