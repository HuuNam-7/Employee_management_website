...
if (empty($_SESSION['error'])) {
    $success = $_SESSION['success']; // only once
...
if (
    isset($_POST['fullName'])      && isset($_POST['email'])    && isset($_POST['gender'])
    ...
    $result = updateD($fullname, $address, $gender, $phone, $email, $country, $id);
}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 mt-3">
                                        <form enctype="multipart/form-data" method="POST">
                                            <div class="card cardProfile mb-4 p-3">
                                                <h2 class="text-center text-info">Edit Profile Department</h2>
                                            </div>
                                            <div class="card cardProfile">
                                                <div class="card-body">
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 text-secondary">
                                                            <button type="submit" class="btn btn-success" name="changeImage">
                                                                Save Change</button>
                                                        </div>
