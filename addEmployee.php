...
if (
    ...
    && isset($_POST['faID']) && isset($_POST['gender'])
    && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['country'])
) {
    ...
    $result = addEmployee($id, $fullname, $address, $img, $faID, $gender, $phone, $email, $country);
}
...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            ?>
            <form class="m-5" method="post" action="addEmployee.php">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="p-3 py-5">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    <label class="labels">Department ID</label>
